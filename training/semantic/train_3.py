...
from training.semantic.model import (
    ...
    DeeplabV3Plus, load_pretrained_hrnet, simple_unet, create_pspnet)
...
if __name__ == "__main__":
    ...
    #model = create_pspnet(input_shape=input_shape, num_classes=train_loader.number_of_classes, output_stride=4)
    ...
    model = create_small_unet_pretrained(input_shape=input_shape, num_classes=train_loader.number_of_classes)
